...
const PaymentMethod = () => {
  ...
  const totalAmount = 8400; // Example total in INR (₹)
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-gray-100 z-50 p-6">
      {/* Payment Container */}
      <div className="bg-white p-8 rounded-lg shadow-lg w-[90%] md:w-2/4 flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-[40%] bg-gray-100 p-6 rounded-lg shadow-md">
          <h2 className="text-black text-xl font-semibold mb-4">
            Order Summary
          </h2>
          <div className="flex items-center justify-between mb-3">
            <span className="text-black">Product Name x5</span>
            <span className="text-black font-semibold">₹7000</span>
          </div>
          <div className="flex items-center justify-between mb-3">
            <span className="text-black">Product Name x1</span>
            <span className="text-black font-semibold">₹1400</span>
          </div>
          <hr className="my-3" />
          <div className="flex justify-between">
            <span className="text-black">Total:</span>
            <span className="text-black font-semibold">₹8400</span>
          </div>
        </div>
      </div>
    </div>
